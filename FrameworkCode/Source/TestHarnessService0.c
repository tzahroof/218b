...
{
  printf("\r\nentered InitTestHarnessService 0");
  MyPriority = Priority;
  /********************************************
...
//    return false;
//  }
  printf("\r\ncompleted InitTestHarnessService0");
}
...
//        //puts("Pulsed!\r");
//      }
//      if ('q' == ThisEvent.EventParam) // FACE_OFF
//      {
//          ES_Event_t GameStatusChange;
//          GameStatusChange.EventType = EV_STATUS_CHANGE;
//          GameStatusChange.EventParam = 0;
//          PostMasterSM(GameStatusChange);
//      }
//      if ('w' == ThisEvent.EventParam) //US_POSS
//      {
//          ES_Event_t GameStatusChange;
//          GameStatusChange.EventType = EV_STATUS_CHANGE;
//          GameStatusChange.EventParam = 1;
//          PostMasterSM(GameStatusChange);
//      }
//      if ('e' == ThisEvent.EventParam) //THEM_POSS
//      {
//          ES_Event_t GameStatusChange;
//          GameStatusChange.EventType = EV_STATUS_CHANGE;
//          GameStatusChange.EventParam = 2;
//          PostMasterSM(GameStatusChange);
//      }
//      if ('r' == ThisEvent.EventParam) //TIE_BREAK
//      {
//          ES_Event_t GameStatusChange;
//          GameStatusChange.EventType = EV_STATUS_CHANGE;
//          GameStatusChange.EventParam = 3;
//          PostMasterSM(GameStatusChange);
//      }
//      if ('t' == ThisEvent.EventParam) //GAME OVER
//      {
//          ES_Event_t GameStatusChange;
//          GameStatusChange.EventType = EV_STATUS_CHANGE;
//          GameStatusChange.EventParam = 4;
//          PostMasterSM(GameStatusChange);
//      }
//    }
//    break;
