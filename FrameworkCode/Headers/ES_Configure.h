...
#define NUM_SERVICES 8 //TODO change number of services
...
#define SERV_0_HEADER "TestHarnessService0.h" //TEST HARNESS DOES NOTHING
...
// the name of the Init function
#define SERV_1_INIT initializeStepService
// the name of the run function
#define SERV_1_RUN RunStepService
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "MasterSM.h"
// the name of the Init function
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "TapeDetectorService.h"
// the name of the Init function
#define SERV_3_INIT InitTapeDetectorService
// the name of the run function
#define SERV_3_RUN RunTapeDetectorService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "ReloadService.h"
// the name of the Init function
#define SERV_4_INIT InitReload
// the name of the run function
#define SERV_4_RUN RunReload
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "OffenceService.h"
// the name of the Init function
#define SERV_5_INIT InitOffence
// the name of the run function
#define SERV_5_RUN RunOffence
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "DefenceService.h"
// the name of the Init function
#define SERV_6_INIT InitDefence
// the name of the run function
#define SERV_6_RUN RunDefence
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "ShooterService.h"
// the name of the Init function
#define SERV_7_INIT InitShooter
// the name of the run function
#define SERV_7_RUN RunShooter
// How big should this services Queue be?
...
#define EVENT_CHECK_LIST checkTowerDetected, GameStatusEventChecker, //Check4Keystroke //TODO: Re-enable GameStatusEventChecker//TODO: Remove Check4Keystroke
...
#define TIMER0_RESP_FUNC PostStepService
#define TIMER1_RESP_FUNC PostStepService
...
#define TIMER9_RESP_FUNC PostDefence
#define TIMER10_RESP_FUNC PostShooter
#define TIMER11_RESP_FUNC PostOffence
#define TIMER12_RESP_FUNC PostReload
#define TIMER13_RESP_FUNC TIMER_UNUSED
#define TIMER14_RESP_FUNC PostTapeDetectorService
#define TIMER15_RESP_FUNC TIMER_UNUSED

/****************************************************************************/
// Give he timer numbers symbolc names to make it easier to move them
...
//TODO: make sure that the appropriate post function is listed
#define PIDTimer 1
#define PrintTimer 0
#define DEFENCE_TIMER 9
#define SHOOT_TIMER 10
#define ReshootTimer 11
#define Ball_Get_Timer 12
#define LFTimer 14
